 ...
 *
 * \code
 * irrklang::ik_vec3df position(23,70,90);
 ...
 *
 * \code
 * irrklang::ik_vec3df position(0,0,0);        // position of the listener
 * irrklang::ik_vec3df lookDirection(10,0,10); // the direction the listener looks into
 * irrklang::ik_vec3df velPerSecond(0,0,0);    // only relevant for doppler effects
 * irrklang::ik_vec3df upVector(0,1,0);        // where 'up' is in your 3D scene
 *
